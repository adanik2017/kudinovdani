...
const ru: Translations = {
  ...
  bio1a: 'Снимаю рекламу и авторское кино — ',
  bio1b: 'большое количество проектов',
  bio1c: ' для самых разных компаний: от небольших брендов до крупных заказчиков.',
  bio2: 'С августа 2025 года полностью перешёл на ИИ-производство. Создаю контент, где технология работает на эмоцию — не наоборот.',
...
const en: Translations = {
  ...
  bio1a: 'I shoot ads and art films — ',
  bio1b: 'a large number of projects',
  bio1c: ' for companies of all sizes: from small brands to major clients.',
  bio2: 'Since August 2025 I have fully transitioned to AI production. I create content where technology serves emotion — not the other way around.',
